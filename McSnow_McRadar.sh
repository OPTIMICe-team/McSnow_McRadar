...
export MCexp=/project/meteo/work/L.Terzi/McSnowoutput/habit/second_nucleation #trajectories #second_nucleation  # folder where to store output 
...
export freq=9.6_35.5_94.0 #35.5 #5.6 #9.6 #35.5 #9.6
export scatMode=SSRGA-Rayleigh #full #SSRGA-Rayleigh
...
export McSnow_testcase=("habit_secondMode") #"habit_secondMode" #habit_trajectories
...
do
    ...
    #minmax_array=(0_350) # 0_180 180_350) # 190_200 210_220 250_260 280_290 310_320 340_350) #210_220 220_230 230_240 240_250 250_260 260_270 270_280 280_290 290_300)
